          ...
          divData.innerHTML = `
              <div class="relative py-3 sm:max-w-xl sm:mx-auto flex flex-col items-center justify-center gap-2">
                ...
                <div class="relative px-4 py-10 bg-[#303032] shadow-lg sm:rounded-3xl sm:p-20">
                  <div id="water_animation" class="flex absolute top-1 mt-8 gap-10 justify-center left-[5.5rem]">
                    <div class="h-14 w-5 bg-gray-300 opacity-10 animate-pulse transform -rotate-12 rounded-full"></div>
                    <div class="h-14 w-5 bg-gray-300 opacity-10 animate-pulse transform rounded-full"></div>
                    <div class="h-14 w-5 bg-gray-300 opacity-10 animate-pulse transform rotate-12 rounded-full"></div>
                  </div>
                  <div class="mt-14 max-w-[24rem] grow-0 flex flex-col items-center justify-center">
                    <p class="font-bold text-white">Name: <span class="font-normal">${pokemonName}</span></p>
                    ...
                    .map(
                      ({ name, image }) => `
                        <div class="flex flex-col items-center justify-center gap-2 my-1">
                          <p class="text-white font-bold">Name: <span class="font-normal hover:cursor-pointer hover:underline hover:text-cyan-200 clickable">${
